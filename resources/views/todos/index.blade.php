        ...
        @forelse ($todos as $todo)
         ...
         <div>
             ...
             @if($todo->completed)
                ...
                @else
        <a class="cursor-pionter" href="{{route('todo.show',$todo->id)}}">{{$todo->title}}</a>
                @endif

            <div>
                <a href="{{route('todo.edit',$todo->id)}}" class=" text-orange-400 rounded cursor-pointer text-white" > <span class="fas fa-edit  px-2"/></a>
